...
age_2018$perc <- round(age_2018$perc/sum_perc*100,2)
...
age_2023$perc <- round(age_2023$perc/sum_perc*100,2)
...
```{r education, echo=FALSE, warning=FALSE, out.width="100%"}
  ...
  education_2018$perc <- round(education_2018$perc/perc_sum*100,2)
  ...
  education_2023$perc <- round(education_2023$perc/perc_sum*100,2)
